...
Invoke the **`audit`** skill to audit the following target: $ARGUMENTS

Follow the audit skill's procedure exactly:
...
4. Print the merged findings as a table and **offer** to hand off to `autofix`.
